...
function createEventListeners(container, button) {
  button.addEventListener('click', ()=>{
    ...
    if (noCounter === 1) {
      ...
      imageHolder.innerHTML = ''; // Clear previous image
      imageHolder.appendChild(changeImage('kanye'));
      ...
      imageHolder.innerHTML = ''; // Clear previous image
      imageHolder.appendChild(changeImage('cringe'));
      ...
      textHolderSecondary.innerHTML=''; 
      imageHolder.innerHTML = ''; // Clear previous image
      imageHolder.appendChild(changeImage('cringe2'));
